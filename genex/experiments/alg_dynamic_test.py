...
# mygxe = from_csv(data, feature_num=0, num_worker=16, use_spark=True, driver_mem=10, max_result_mem=10, _rows_to_consider=24)
...
print('Dynamic Building took ' + str(time.time() - start) + ' sec')


start = time.time()
mygxe.build(st=0.2, loi=(5, 6), _use_dynamic=False)
print('Regular Building took ' + str(time.time() - start) + ' sec')
