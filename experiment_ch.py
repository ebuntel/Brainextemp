...
ch_start_time = datetime.datetime.now()
c_ch = do_gcluster(input_list=res_list, loi=[50, 150], sc=sc, similarity_threshold=0.1, del_data=True, is_collect=True, dist_type='ch',
                data_slices=1024, log_level=1)
ch_end_time = datetime.datetime.now()